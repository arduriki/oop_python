...
def newAccount(name, balance, password):
    global accountName, accountBalance, accountPassword  # inform Python we want to modify the variable's value.
    accountName = name
...
def show():
    global accountName, accountBalance, accountPassword  # variables defined the function
...
def getBalance(pasword):
    global accountName, accountBalance, accountPassword
    if pasword != accountPassword:
...
while True:
    ...
    if action == 'b':
        ...
        newBalance = withdraw(userWithdrawalAmount, userPassword)
        if newBalance is not None:
            print('Your new balance is:', newBalance)
